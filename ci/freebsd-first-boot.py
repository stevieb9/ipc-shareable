...
def get_instance_id():
    ...
    Works on macOS and Linux without mounting. Linux Lima can emit a
    multi-hundred-MB cidata.iso (xorrisofs padding); grep streams the file
    rather than reading it all into Python.
    """
